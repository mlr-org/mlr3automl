...
- [`LearnerClassifAutoLightGBM$new()`](#method-LearnerClassifAutoLightGBM-initialize)

- [`LearnerClassifAutoLightGBM$clone()`](#method-LearnerClassifAutoLightGBM-clone)
...
learner
#> 
#> ── <LearnerClassifAutoLightGBM> (classif.auto_lightgbm) ────────────────────────
#> • Model: -
