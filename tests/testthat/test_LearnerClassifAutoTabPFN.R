test_that("LearnerClassifAutoTabPFN is initialized", {
...
test_that("LearnerClassifAutoTabPFN is trained", {
  skip_on_cran()
  ...
  expect_equal(learner$graph$param_set$values$branch.selection, "tabpfn")
