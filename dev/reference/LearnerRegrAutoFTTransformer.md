...
- [`LearnerRegrAutoFTTransformer$new()`](#method-LearnerRegrAutoFTTransformer-initialize)

- [`LearnerRegrAutoFTTransformer$clone()`](#method-LearnerRegrAutoFTTransformer-clone)
...
learner
#> 
#> ── <LearnerRegrAutoFTTransformer> (regr.auto_ft_transformer) ───────────────────
#> • Model: -
