...
- [`LearnerRegrAutoTabFM$new()`](#method-LearnerRegrAutoTabFM-initialize)

- [`LearnerRegrAutoTabFM$clone()`](#method-LearnerRegrAutoTabFM-clone)
...
#### Usage
    ...
    LearnerRegrAutoTabFM$new(id = "regr.auto_tabfm", rush = NULL)
...
### `LearnerRegrAutoTabFM$clone()`

The objects of this class are cloneable with this method.

#### Usage

    LearnerRegrAutoTabFM$clone(deep = FALSE)
...
if (mlr3misc::require_namespaces(c("mlr3extralearners", "callr"), quietly = TRUE)) {
  learner = lrn("regr.auto_tabfm")
  learner
}
#> 
#> ── <LearnerRegrAutoTabFM> (regr.auto_tabfm) ────────────────────────────────────
#> • Model: -
