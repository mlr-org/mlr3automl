...
LearnerClassifAuto = R6Class("LearnerClassifAuto",
  ...
  public = list(
    ...
    initialize = function(
      id = "classif.auto",
      learner_ids = c("glmnet", "kknn", "lda", "ranger", "svm", "xgboost", "catboost", "extra_trees", "lightgbm", "fastai", "mlp")
      ) {
      assert_subset(learner_ids, c("glmnet", "kknn", "lda", "ranger", "svm", "xgboost", "catboost", "extra_trees", "lightgbm", "fastai", "mlp"))
