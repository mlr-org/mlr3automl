...
- [`LearnerClassifAutoTabFM$new()`](#method-LearnerClassifAutoTabFM-initialize)

- [`LearnerClassifAutoTabFM$clone()`](#method-LearnerClassifAutoTabFM-clone)
...
#### Usage
    ...
    LearnerClassifAutoTabFM$new(id = "classif.auto_tabfm", rush = NULL)
...
### `LearnerClassifAutoTabFM$clone()`

The objects of this class are cloneable with this method.

#### Usage

    LearnerClassifAutoTabFM$clone(deep = FALSE)
...
``` r
learner = lrn("classif.auto_tabfm")
learner
#> 
#> ── <LearnerClassifAutoTabFM> (classif.auto_tabfm) ──────────────────────────────
#> • Model: -
