...
- [`LearnerClassifAutoXgboost$new()`](#method-LearnerClassifAutoXgboost-initialize)

- [`LearnerClassifAutoXgboost$clone()`](#method-LearnerClassifAutoXgboost-clone)
...
learner
#> 
#> ── <LearnerClassifAutoXgboost> (classif.auto_xgboost) ──────────────────────────
#> • Model: -
